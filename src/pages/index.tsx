  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock Your Potential with Visionaire: Empowering Students with Essential Life Skills in Money, Leadership, Communication, and Business."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock Your Potential with Visionaire: Empowering Students with Essential Life Skills in Money, Leadership, Communication, and Business.`}
            </Text>
            <Box
